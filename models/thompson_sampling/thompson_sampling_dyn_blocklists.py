...
from thompson_sampling import ThompsonSampling, ThompsonSamplingParserOptions, ThompsonSamplingActionSpace


class ThompsonSamplingDynamicDate(ThompsonSampling):
    """
...
class ThomsponSamplingDynParserOptions(ThompsonSamplingParserOptions):
...
if __name__ == "__main__":
    parser = ThomsponSamplingDynParserOptions()
    params = parser.parse()
    ...
    run_multiprocessing(ThompsonSamplingDynamicDate, params,
