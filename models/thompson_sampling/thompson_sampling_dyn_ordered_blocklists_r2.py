...
from models.thompson_sampling.thompson_sampling import ThompsonSamplingActionSpace
from thompson_sampling_dyn_ordered_blocklists import ThompsonSamplingDynamicOrderedDate, \
    ThomsponSamplingOrderedParserOptions
from common.utils import reward_in_blocklist_by_date_prioritize_changes


class ThompsonSamplingDynamicOrderedDateR2(ThompsonSamplingDynamicOrderedDate):
...
if __name__ == "__main__":
    parser = ThomsponSamplingOrderedParserOptions()
    params = parser.parse()
    ...
    run_multiprocessing(ThompsonSamplingDynamicOrderedDateR2, params,
