...
import numpy as np
import pandas as pd
from epsilon_greedy_sampling import EpsilonGreedySampling, EpsilonGreedySamplingParserOptions
...
class EpsilonGreedySamplingDynamicDate(EpsilonGreedySampling):
    """
...
class EpsilonGreedySamplingDynParserOptions(EpsilonGreedySamplingParserOptions):
...
if __name__ == "__main__":
    parser = EpsilonGreedySamplingDynParserOptions()
    params = parser.parse()

    addition_kwargs = {"selected_target_max_try": params["selected_target_max_try"],
                       "model_runner": DynModelRun()}

    run_multiprocessing(EpsilonGreedySamplingDynamicDate, params, addition_kwargs=addition_kwargs)
