...
from epsilon_greedy_sampling_dyn_ordered_blocklists import EpsilonGreedySamplingDynamicOrderedDate, \
    EpsilonGreedySamplingOrderedParserOptions
...
class EpsilonGreedySamplingDynamicOrderedDateR2(EpsilonGreedySamplingDynamicOrderedDate):
...
if __name__ == "__main__":
    ...
    run_multiprocessing(EpsilonGreedySamplingDynamicOrderedDateR2, params, addition_kwargs=addition_kwargs)
